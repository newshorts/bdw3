<section id="charlotte" class="hidden">
    <div class="story">
	<div class="midground"></div>
    	<div class="float-right">
            <h2>Charlotte<br />Myerberg</h2>
            <article>
...
<section id="laura" class="hidden">
	<div class="story">
            <div class="midground"></div>
            <div class="float-right">
                <h2>Laura<br />Hamrick</h2>
                <article>
...
<section id="josh" class="hidden">
	<div class="story">
            <div class="midground"></div>
            <div class="float-right">
                <h2 class="darker">Josh<br />Kadis</h2>
                <article>
...
<section id="megan" class="hidden">
	<div class="story">
            <div class="midground"></div>
            <div class="float-right">
                <h2 class="darker">Megan<br />Newton</h2>
                <article>
...
<section id="patrick" class="hidden">
	<div class="story">
            <div class="midground"></div>
            <div class="float-right">
                <h2>Patrick<br />Anders</h2>
                <article>
...
<section id="lauren" class="hidden">
	<div class="story">
            <div class="midground"></div>
            <div class="float-right">
                <h2 class="darker">Lauren<br />Parker</h2>
                <article>
...
<section id="mike" class="hidden">
	<div class="story">
		<video id="mikeVideo" autoplay="autoplay" loop="loop">
			<source src="http://s3.amazonaws.com/iwearshorts-video/mike-student-site.ogv" type='video/ogg; codecs="theora, vorbis"'>
			<source src="http://s3.amazonaws.com/iwearshorts-video/mike-student-site.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40"'>
			<!--
<object type="application/x-shockwave-flash" data="http://s3.amazonaws.com/iwearshorts-video/mike-student-site.swf">
				<param name="movie" value="http://s3.amazonaws.com/iwearshorts-video/mike-student-site.swf" />
				<param name="flashvars" value="autostart=true&amp;controlbar=over&amp;file=http://s3.amazonaws.com/iwearshorts-video/mike-student-site.mp4" />
				<p>Your browser doesn't support video. Please download the video in <a href=http://s3.amazonaws.com/iwearshorts-video/mike-student-site.ogv>Ogg</a> or <a href=http://s3.amazonaws.com/iwearshorts-video/mike-student-site.mp4>mp4</a> format.</p>
			</object>
-->
		</video>
		<canvas id="code" width="600" height="400"></canvas>
		<canvas id="feel" width="400" height="150"></canvas>
		<a href="http://iwearshorts.com/"><canvas id="more" width="300" height="75"></canvas></a>
		<script type="text/javascript">
			var mike = function (fill) {
				...
				var codeCTX = code.getContext("2d");
				
				codeCTX.translate(0.5, 0.5);
				
				codeCTX.font = "bold 112px Helvetica Neue, sans-serif";
				codeCTX.fillStyle    = fill;
				
				codeCTX.shadowColor = fill;
				codeCTX.shadowOffsetX = 0;
				codeCTX.shadowOffsetY = 0;
				codeCTX.shadowBlur = 1;
				
				codeCTX.textBaseline = "top";
				codeCTX.fillText("i", 50, 0);
				
				codeCTX.textBaseline = "top";
				codeCTX.fillText("code", 55, 60);

				codeCTX.textBaseline = "top";
				codeCTX.fillText("because...", 50, 140);
				
				// feel
				var feel = document.getElementById("feel");
				
				feel.width = feel.width;
				
				var feelCTX = feel.getContext("2d");
				
				feelCTX.font = "400 24px HelveticaNeue-Light, Helvetica Neue Light, Helvetica Neue, sans-serif";
				feelCTX.fillStyle = fill;
				
				feelCTX.textBaseline = "top";
				feelCTX.fillText('"i love the feeling of', 0, 0);
				
				feelCTX.font = "500 72px HelveticaNeue-Light, Helvetica Neue Light, Helvetica Neue, sans-serif";
				...
				feelCTX.textBaseline = 'top';
				feelCTX.fillText('creating."', 75, 17);
                                
                                feelCTX.font = "400 18px HelveticaNeue-Light, Helvetica Neue Light, Helvetica Neue, sans-serif";
				feelCTX.fillStyle = fill;
                                
                                feelCTX.textBaseline = "top";
				feelCTX.fillText('- Mike Newell', 280, 105);
				
				// more
				var more = document.getElementById("more");
				
				more.width = more.width;
				var moreCTX = more.getContext("2d");
				
				moreCTX.fillStyle    = '#000';
				moreCTX.fillRect(0,0,200,36);
				moreCTX.fillRect(65,30,300,36);
								
				moreCTX.font = "500 italic 18px Helvetica Neue, sans-serif";
				moreCTX.fillStyle    = '#fff';
				
				moreCTX.textBaseline = "top";
				moreCTX.fillText("come check me out", 20, 5);
				
				moreCTX.textBaseline = "top";
				moreCTX.fillText("and see what else i can do", 75, 36);
...
<script type="text/javascript">
	...
	var Josh = new Page("#josh", 6250, 7150, 50, 35);
	var Max = new Page("#max", 7500, 8500, 50, 10);
	var Megan = new Page("#megan", 8750, 9750, 50, 10);
	var Patrick = new Page("#patrick", 10000, 11000, 50, 0);
	var Jon = new Page("#jon", 11250, 12350, 50, 0);
	var Lauren = new Page("#lauren", 12500, 13400, 50, 0);
	var Rj = new Page("#rj", 13750, 14950, 50, 10);
	var Mike = new Page("#mike", 15000, 16350, 50, 10);
</script>